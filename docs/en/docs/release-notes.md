...
- [CQRS (Command Query Responsibility Segregation) support](./contrib/cqrs.md) under `ravyn.contrib.cqrs`.
...
- Message envelopes with metadata support, fully compatible with Ravyn encoders (`apply_structure`, `json_encode`).
