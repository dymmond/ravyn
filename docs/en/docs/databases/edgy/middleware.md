...
- How JWT authentication works with Edgy
...
This middleware extends the [AuthenticationMiddleware](../../middleware/index.md#authenticationmiddleware) and enables JWT-based authentication for your Edgy models.
...
| `user` | Type[Model] | User model class (not instance!) | Yes |
...
- [User Models](./models.md) - User model documentation
...
- [User Models](./models.md) - Set up user authentication
